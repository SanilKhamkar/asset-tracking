...
class CLI
{
    ...
    {
        if (!file_exists("app/managers/".$name.".php")) {
            $managerFile = fopen("app/managers/".$name.".php", "w") or die("Unable to open file!");
            $content = "";
            $content .= "<?php";
            $content .= "\n";
            $content .= "class ".$name;
            ...
            $content .= "\n";
            $content .= "\n";
            $content .= "    public function managerFunction()";
            $content .= "\n";
            $content .= "    {";
            $content .= "\n";
            $content .= "    }";
            ...
            // Output Success
            print_r("Model: app/managers/".$name.".php created!");
        } else {
            // Output Failure
            print_r("FAILED. app/managers/".$name.".php already exists.");
        }
    }
}