...
<div id="" class="mt-3" style="background: #00203FFF; border-bottom: solid 1px #e0e0e0 !important; border-top: solid 1px #e0e0e0 !important;">
    <div class="container mt-3 mb-3">
        <div class="row">
            <div class="col border-info border-3">
                <div class="fs-1" style="color: #ADEFD1FF">GRAND PRIX BOOSTS</div>
            </div>
        </div>
    </div>
</div>
...
<div class="container mt-3">
    <div class="row">
        <?php 
            foreach($gpboostdata as $name=>$data) {
        ?>
        <div class="col-md-2 me-4">
            <div class="card" style="width: 13rem; background: #00203FFF;">
                <h5 class="card-header text-white text-center"><?=$name?></h5>
